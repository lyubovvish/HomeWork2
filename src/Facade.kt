//Facade включает в себя один класс, который предоставляет упрощенные методы,
//требуемые клиентом, и делегирует вызовы методам существующих системных классов
//показано упрощенный метод делегируемых вызовы методам существующих системных классов
